...
have a factory named "event." FactoryGirl guesses the object's class based
...
controllers within "api/v1" directory so we may release future versions of
...
will include our views in the "api/v1" directory so they are versioned.
